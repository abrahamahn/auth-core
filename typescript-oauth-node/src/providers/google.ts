...
export function createGoogleProvider(config: GoogleProviderConfig): OAuthProviderClient {
  ...
  return {
    ...
    getAuthorizationUrl(
      ...
      if (config.requestOfflineAccess ?? true) params.set('access_type', 'offline');
